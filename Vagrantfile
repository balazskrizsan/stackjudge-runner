...
Vagrant.configure("2") do |config|
  ...
  config.vm.network "forwarded_port", guest: 54322, host: 54322, host_ip: "127.0.0.1"
  config.vm.network "forwarded_port", guest: 54323, host: 54323, host_ip: "127.0.0.1"
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    echo " - :5432  / Postgres"
    echo " - :54320 / Postgres/SJ - dev"
    echo " - :54321 / Postgres/SJ - dev test"
    echo " - :54322 / Postgres/IDS - dev"
    echo " - :54323 / Postgres/IDS - dev test"
    echo " - :6379  / redis"
